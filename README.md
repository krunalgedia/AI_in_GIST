...
| Kolmogrow Smironov | Continuous variables, >2000 data, non-parametric test (no underlying hypothesis) |
...
| R squared | Similar to R squared but takes model complexity into account (DOF) |
